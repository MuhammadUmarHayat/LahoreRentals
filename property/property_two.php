...
<div class="container pt-5 pb-5">
  <div class="row g-4">
    ...
    <div class="col-md-4">
      <h3 class="text-muted">Rent/Month: 67,000 RS</h3>
    </div>
    <br>
    <div class="col-md-6 text-center">
      <img src="../images/bg/apartment-single-1.jpeg" alt="" width="100%" class="img-fluid rounded-3">
    </div>
    <div class="col-md-6">
      <div class="setting-tabs">
        <h4>Property Details</h4>
        <p><b>Address & Area :</b>  House-48, DHA Phase 5, Islamabad, Pakistan</p>
        <p><b>Apartment Size :</b> 3000 Sq Feet.</p>
        <p><b>Floor :</b> A5 (5th Floor) (6 storied Building ) (South Facing Unit)</p>
        <p><b>Room Category :</b> 2 Large Bed Rooms with 2 Veranda, Spacious Drawing, Dining & Family Living Room, Highly Decorated Kitchen with Store Room and Servant room with attached Toilet.</p>
