...
<div class="container pt-5 pb-5">
  <div class="row g-4">
    ...
    <div class="col-md-4">
      <h3 class="text-muted">Rent/Month: 100,000 RS</h3>
    </div>
    <br>
    <div class="col-md-6 text-center">
      <img src="../images/bg/apartment-single.jpeg" alt="" width="100%" class="img-fluid rounded-3">
    </div>
    <div class="col-md-6">
      <div class="setting-tabs">
        <h4>Property Details</h4>
        <p><b>Address & Area :</b>  House-28, Bahria Town Phase 2, Islamabad, Pakistan</p>
        <p><b>House Size :</b> 7000 Sq Feet.</p>
        <p><b>Room Category :</b> 5 Large Bed Rooms with 3 Verandas, Spacious Drawing, Dining & Family Living Room, Highly Decorated Kitchen with Store Room and Servant room with attached Toilet.</p>
