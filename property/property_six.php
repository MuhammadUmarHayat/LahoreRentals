...
<div class="container pt-5 pb-5">
  <div class="row g-4">
    ...
    <div class="col-md-4">
      <h3 class="text-muted">Rent/Month: 25,000 RS</h3>
    </div>
    <br>
    <div class="col-md-6 text-center">
      <img src="../images/bg/apartment-single-4.jpeg" alt="" width="100%" class="img-fluid rounded-3">
    </div>
    <div class="col-md-6">
      <div class="setting-tabs">
        <h4>Property Details</h4>
        <p><b>Address & Area :</b> 64 A, Beach Area, Karachi Pakistan</p>
        <p><b>Apartment Size :</b> 2000 Sq Feet.</p>
        <p><b>Room Category :</b> 1 Large Bed Room , Spacious Drawing, Dining & Family Living Room, Highly Decorated Kitchen with Store Room and Servant room with attached Toilet.</p>
